...
class TaskRunner:
    def run(self, config):
        ...
        # Extract structured output specific reward params
        reward_mode = config.get("structured_output", {}).get("reward_mode", "fine_grained")
        reasoning_delimiter = config.get("structured_output", {}).get("reasoning_delimiter", "<answer>")
        reasoning_end_delimiter = config.get("structured_output", {}).get("reasoning_end_delimiter", "</answer>")
        reasoning_bonus = config.get("structured_output", {}).get("reasoning_bonus", 0.1)
        reward_weights = config.get("structured_output", {}).get("reward_weights", None)
        ...
        reward_fn = load_reward_manager(
            ...
            reasoning_delimiter=reasoning_delimiter,
            reasoning_end_delimiter=reasoning_end_delimiter,
